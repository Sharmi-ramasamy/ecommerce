...
const [nameError, setNameError] = useState("")
    ...
    const handleSubmit =(event)=> {
        ...
        axios.post("http://localhost:4042/CheckoutDetails",checkout)
        // {
            // "name":name,
            // "email":email,
            // "address":address,
  ...
  return (
    ...
    <div className="checkout-box">
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" name="firstname" placeholder="Full Name" onChange={(e)=>setName(e.target.value)}/>
            ...
            <label> <i className="fa fa-address-card"></i> Address</label>
            ...
            <label> State </label>
            <input type="text" name="state" placeholder="Town" onChange={(e)=>setState(e.target.value)}/>

            <label> Zip </label>
            <input type="text" name="zip" placeholder="Zipcode" onChange={(e)=>setZip(e.target.value)}/>

            <button className='buttons' type="submit" > Continue to Checkout </button>
